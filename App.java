...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(ålder+ " år"); 
        System.out.println(längd+ " cm");
        System.out.println(vikt+ " kg");

        int Ålderint;
        Ålderint = Integer.valueOf(ålder);
        Ålderint = Ålderint%2 + Ålderint;
        System.out.println("nästa gång du fyller jämt är du "+ Ålderint);

        double Viktint;
        Viktint = Double.valueOf(vikt);
        System.out.println(vikt);
        System.out.println("Du är närmast " + Math.floor(Viktint)+"kg");
